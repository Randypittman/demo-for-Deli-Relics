  ...
  return (
    <div className="navbar-dark bg-dark shadow">
      ...
      <div className="container-fluid">
        ...
        <button className="navbar-toggler btn btn-primary bg-light" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
